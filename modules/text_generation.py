...
def generate_reply(*args, **kwargs):
    ...
    use_parallel = (
        ...
        and shared.model.__class__.__name__ in ['Exllamav3Model', 'LlamaServer', 'TensorRTLLMModel', 'LMDeployModel']
...
def _generate_reply(question, state, stopping_strings=None, is_chat=False, escape_html=False, for_ui=False):
    ...
    if generate_func is None:
        ...
        if shared.model.__class__.__name__ in ['LlamaServer', 'Exllamav3Model', 'TensorRTLLMModel', 'LMDeployModel']:
...
def encode(prompt, add_special_tokens=True, add_bos_token=True, truncation_length=None):
    ...
    # llama.cpp case
    if shared.model.__class__.__name__ in ['LlamaServer', 'LMDeployModel']:
